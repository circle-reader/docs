...
- 上线新应用 “复制为 markdown”，详情可以[看这里](/node/5627)
...
**促销提示**：2022 年 10 月 31 日前升级为[高级帐户](/node/22)打八折哦。
...
随着本次更新，**升级高级帐户打八折哈，**已经是高级帐户的再次购买可以**累加到期日期**哦（已经是高级会员的，若发现高级帐户丢失，请在扩展设置页面退出重新登录下帐户即可）。[立即升级](/node/22)
...
你可以通过设置对应的快捷键（[如何设置快捷键？](/node/60)）或者通过开启对应的工具栏工具（[如何自定义工具栏？](/node/61)）使用。
...
大屏幕用户的福利，使用分栏阅读你可以单屏幕阅读更多的信息，不浪费屏幕的每一寸空间。[如何开启？](/node/33)

![](https://circlereader.com/sites/default/files/column.png)

## 大声朗读

阅读累了？不如试试听内容吧！解放双手去做其他有意思的事情，比如点个外卖啃个鸡爪。借助于“[多页解析](/node/36)”和“[本地文件支持](/node/28)”，听小说利器，要啥自行车。[了解更多](/node/39)
...
- 标题识别算法优化，支持类似网页标题和文章标题完全不相关的情况，如：[https://page.om.qq.com/page/OLK3MWsrtVhiV3fPVfxqSGDQ0](https://page.om.qq.com/page/OLK3MWsrtVhiV3fPVfxqSGDQ0)
- 渲染算法优化，对部分网站图片展示失败作处理
- 自动解析下一页算法优化，支持更多的网站：如“观察者”网站
- 新增主图识别算法，可以识别大部分页面主图，如：[http://daily.zhihu.com/story/8822957(beta)](<http://daily.zhihu.com/story/8822957(beta)>)
- 新增支持自定义标题对齐方式
...
- 无法在阅读模式中使用 element.scrollIntoView() 或者 window.scrollTo({top: 1000}) #12 [https://github.com/hewenguang/circle/issues/12](https://github.com/hewenguang/circle/issues/12)
- 打印设置优化 #3 [https://github.com/hewenguang/circle/issues/3](https://github.com/hewenguang/circle/issues/3)
- 点击空格滚动失败
