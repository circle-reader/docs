...
欢迎您使用 Circle 阅读助手（以下简称我们或本网站），我们将努力为你提供更优秀的用户体验。在使用前，请认真阅读并同意我们的《用户协议》和[《隐私政策》](/privacy.md)，了解你的用户权益和相关使用数据的处理办法。
...
1．如果您是未满 16 岁的未成年人，须在监护人的陪同和帮助下仔细阅读本协议，并在征得您监护人同意的前提下，使用我们的产品或服务或向我们提供信息。
...
7．我们不存储和复制数据，仅通过再排版功能提升用户的阅读体验，您可以在每篇文章的底部找到原始网页的地址。我们不建议使用她来排版具有版权风险的内容，如果您无视我们的建议将视为您自己的行为，我们不承担任何法律责任；

8．排版后使用的字体是调用您电脑安装的字体，我们不提供任何字体，我们也不承担因为使用未授权的商业字体而造成的任何法律责任；
